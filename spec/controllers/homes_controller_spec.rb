  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new Home" do
        expect {
          post :create, :home => valid_attributes
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested home" do
        ...
        Home.any_instance.should_receive(:update_attributes).with({'these' => 'params'})
        put :update, :id => home.id, :home => {'these' => 'params'}
      end

      it "assigns the requested home as @home" do
        home = Home.create! valid_attributes
        put :update, :id => home.id, :home => valid_attributes
        assigns(:home).should eq(home)
      end
    ...
    describe "with invalid params" do
      it "assigns the home as @home" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Home.any_instance.stub(:save).and_return(false)
        put :update, :id => home.id.to_s, :home => {}
        assigns(:home).should eq(home)
      end
